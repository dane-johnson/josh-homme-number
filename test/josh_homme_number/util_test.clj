...
(expect (format "Arthur Dent was in The Resturant at the End of the Universe with Ford Prefect who was in Life, the Universe and Everything with Hotblack Desatio%n")
        (with-out-str
          (print-path
